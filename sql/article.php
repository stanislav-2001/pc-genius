...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="<?php echo $tagy; ?>">
        <meta charset="UTF-8">
    </head>
    <body>
        <main id="body">
            ...
            <section id="sleft">
                <div class="fill">
                    <div id="headbox" style="background-image:url('<?php echo $vys["obr_semiurl"]; ?>')">
                        ...
                        <div id="headbox-overlay">
                            <div class="rel">
                                <div class="center-text"><h1><?php echo $vys["nazov"]; ?></h1></div>
                            </div>
                        </div>
                    </div>
                ...
                *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables*/
                ...
                this.page.url = FNAME;  // TODO: Replace PAGE_URL with your page's canonical URL variable
